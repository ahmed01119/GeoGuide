...
class _AllPlaceCard extends StatelessWidget {
  ...
  String get _description {
    if (place.shortDescription.isNotEmpty) return place.shortDescription;
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (place.category.isNotEmpty && place.city.isNotEmpty)
